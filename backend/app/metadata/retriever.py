...
_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "平均年龄": ("average_customer_age", "ads_cust_info_d", "cust_age", "平均年龄"),
    "普通账户总资产": (
        "normal_total_asset",
        "dws_cust_aset_d",
        "nm_tot_aset",
    ...
    "普通资产": ("normal_total_asset", "dws_cust_aset_d", "nm_tot_aset", "普通资产"),
    "信用账户净资产": (
        "credit_total_asset",
        "dws_cust_aset_d",
        "fc_pur_aset",
    ...
    "信用资产": ("credit_total_asset", "dws_cust_aset_d", "fc_pur_aset", "信用资产"),
    ...
    "成交数量": ("trade_quantity", "dwd_cust_tran_d", "buy_mnt", "sell_mnt", "成交数量"),
    "交易数量": ("trade_quantity", "dwd_cust_tran_d", "buy_mnt", "sell_mnt", "交易数量"),
    "交易费用": ("trade_fee", "dwd_cust_tran_d", "buy_fare", "sell_fare", "交易费用"),
    "双向交易": (
    ...
    "一级营业部": ("dim_branch", "up_org_name", "一级营业部"),
    ...
    "转账金额": ("transfer_amount", "dws_cust_fin_d", "tran_in", "tran_out", "转账金额"),
    "划拨金额": (
        "assignment_amount",
        "dws_cust_fin_d",
        "assign_in",
...
_METRIC_TABLES: dict[str, tuple[str, ...]] = {
    ...
    "average_customer_age": ("ads_cust_info_d",),
    "normal_total_asset": ("dws_cust_aset_d", "ads_cust_info_d"),
    "credit_total_asset": ("dws_cust_aset_d", "ads_cust_info_d"),
    ...
    "trade_fee": ("dwd_cust_tran_d", "dim_product", "ads_cust_info_d"),
    "trade_quantity": ("dwd_cust_tran_d", "dim_product", "ads_cust_info_d"),
    "bidirectional_trade_customer": ("dwd_cust_tran_d", "ads_cust_info_d"),
    "distinct_holding_product_count": ("dwd_cust_hold_d", "dim_product", "ads_cust_info_d"),
    "net_cash_flow": ("dws_cust_fin_d", "ads_cust_info_d"),
    "net_cash_inflow": ("dws_cust_fin_d", "ads_cust_info_d"),
    "transfer_amount": ("dws_cust_fin_d", "ads_cust_info_d"),
    "assignment_amount": ("dws_cust_fin_d", "ads_cust_info_d"),
